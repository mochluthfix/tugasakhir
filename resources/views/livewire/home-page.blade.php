<div class="w-full min-h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">  
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Sejak Tahun 1950 <span class="text-blue-600">Mie Kocok H. Amsar</span></h1>
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Menerima Pesanan Pesta, Pernikahan, dll</p>
        ...
        <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
          ...
          <div class="py-5">
            ...
            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
              <span class="font-bold">4.6</span> /5 - dari 1.000 lebih ulasan 
            </p>
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-200"> Browse <span class="text-blue-500"> Products
            </span> </h1>
        ...
        <p class="mb-12 text-base text-center text-gray-500">
         Mie Kocok H Amsar 
         Buka Setiap Hari dari jam 08.00 s/d 20.00
        </p>
      </div>
    </div>
